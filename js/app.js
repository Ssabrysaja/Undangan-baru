...
const timer = () => {
    ...
    time = setInterval(() => {
        ...
        document.getElementById('hari').innerText = Math.floor(distance / (1000 * 60 * 60 * 72 ));
        document.getElementById('jam').innerText = Math.floor((distance % (1000 * 60 * 60 * 1 )) / (1000 * 60 * 60));
        document.getElementById('menit').innerText = Math.floor((distance % (1000 * 60 * 1)) / (1000 * 60));
